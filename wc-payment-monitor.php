...
class WC_Payment_Monitor {
	...
	private function load_dependencies() {
		...
		require_once WC_PAYMENT_MONITOR_PLUGIN_DIR . 'includes/alerts/class-wc-payment-monitor-alert-template-manager.php';
		require_once WC_PAYMENT_MONITOR_PLUGIN_DIR . 'includes/alerts/class-wc-payment-monitor-alert-notifier.php';
		require_once WC_PAYMENT_MONITOR_PLUGIN_DIR . 'includes/alerts/class-wc-payment-monitor-alert-checker.php';
		require_once WC_PAYMENT_MONITOR_PLUGIN_DIR . 'includes/alerts/class-wc-payment-monitor-alerts.php';

		require_once WC_PAYMENT_MONITOR_PLUGIN_DIR . 'includes/core/class-wc-payment-monitor-retry.php';
		require_once WC_PAYMENT_MONITOR_PLUGIN_DIR . 'includes/core/class-wc-payment-monitor-security.php';

		// Load gateway connector classes.
		require_once WC_PAYMENT_MONITOR_PLUGIN_DIR . 'includes/gateways/class-wc-payment-monitor-gateway-connector.php';
		require_once WC_PAYMENT_MONITOR_PLUGIN_DIR . 'includes/gateways/class-wc-payment-monitor-stripe-connector.php';
		require_once WC_PAYMENT_MONITOR_PLUGIN_DIR . 'includes/gateways/class-wc-payment-monitor-paypal-connector.php';
		require_once WC_PAYMENT_MONITOR_PLUGIN_DIR . 'includes/gateways/class-wc-payment-monitor-wc-payments-connector.php';
		require_once WC_PAYMENT_MONITOR_PLUGIN_DIR . 'includes/gateways/class-wc-payment-monitor-gateway-connectivity.php';

		// Load API classes.
		require_once WC_PAYMENT_MONITOR_PLUGIN_DIR . 'includes/api/class-wc-payment-monitor-api-base.php';
		require_once WC_PAYMENT_MONITOR_PLUGIN_DIR . 'includes/api/class-wc-payment-monitor-api-health.php';
		require_once WC_PAYMENT_MONITOR_PLUGIN_DIR . 'includes/api/class-wc-payment-monitor-api-transactions.php';
		require_once WC_PAYMENT_MONITOR_PLUGIN_DIR . 'includes/api/class-wc-payment-monitor-api-alerts.php';

		// Load PRO analytics classes.
		require_once WC_PAYMENT_MONITOR_PLUGIN_DIR . 'includes/class-wc-payment-monitor-analytics-pro.php';
		require_once WC_PAYMENT_MONITOR_PLUGIN_DIR . 'includes/api/class-wc-payment-monitor-api-analytics-pro.php';

		// Load diagnostic and testing tools.
		require_once WC_PAYMENT_MONITOR_PLUGIN_DIR . 'includes/core/class-wc-payment-monitor-diagnostics.php';
		require_once WC_PAYMENT_MONITOR_PLUGIN_DIR . 'includes/utils/class-wc-payment-monitor-failure-simulator.php';
		require_once WC_PAYMENT_MONITOR_PLUGIN_DIR . 'includes/api/class-wc-payment-monitor-api-diagnostics.php';

		// Load admin handler classes (order matters - dependencies first)
		require_once WC_PAYMENT_MONITOR_PLUGIN_DIR . 'includes/admin/class-wc-payment-monitor-admin-menu-handler.php';
		require_once WC_PAYMENT_MONITOR_PLUGIN_DIR . 'includes/admin/class-wc-payment-monitor-admin-settings-handler.php';
		require_once WC_PAYMENT_MONITOR_PLUGIN_DIR . 'includes/admin/class-wc-payment-monitor-admin-page-renderer.php';
		require_once WC_PAYMENT_MONITOR_PLUGIN_DIR . 'includes/admin/class-wc-payment-monitor-admin-ajax-handler.php';
		require_once WC_PAYMENT_MONITOR_PLUGIN_DIR . 'includes/admin/class-wc-payment-monitor-admin.php';
	}
