...
class WC_Payment_Monitor
{
    ...
    private function init_hooks()
    {
        ...
        register_uninstall_hook(__FILE__, ['WC_Payment_Monitor', 'uninstall']);
    ...
    private function init_gateway_connectivity_scheduler()
    {
        ...
        add_action('wc_payment_monitor_gateway_connectivity_check', [$this, 'run_gateway_connectivity_check']);
    }
    ...
    private function set_default_options()
    {
        $default_settings = [
            ...
            'alert_threshold'        => 85,
            'gateway_alert_config'   => [], // Per-gateway configuration (Pro+ feature)
            'monitoring_interval'    => 300, // 5 minutes
            'enable_auto_retry'      => true,
            'retry_schedule'         => [3600, 21600, 86400], // 1h, 6h, 24h
            'license_key'            => '',
        ];
