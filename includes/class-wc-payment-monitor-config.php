...
/**
 * WC_Payment_Monitor_Config class
 *
 * Manages plugin configuration with caching and validation.
 */
class WC_Payment_Monitor_Config {

	/**
	 * Option key constants
	 */
	public const OPTION_MAIN_OPTIONS    = 'wc_payment_monitor_options';
	public const OPTION_SETTINGS        = 'wc_payment_monitor_settings';
	public const OPTION_SLACK_WORKSPACE = 'wc_payment_monitor_slack_workspace';
	public const OPTION_QUOTA_EXCEEDED  = 'wc_payment_monitor_quota_exceeded';
	 ...
	 *
	 * @return WC_Payment_Monitor_Config
	 */
