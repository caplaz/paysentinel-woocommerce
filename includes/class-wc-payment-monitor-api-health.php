...
class WC_Payment_Monitor_API_Health extends WC_Payment_Monitor_API_Base
{
    ...
    public function register_routes()
    {
        ...
        register_rest_route(
            ...
            [
                'methods'             => 'GET',
                'callback'            => [$this, 'get_all_gateway_health'],
        ...
        register_rest_route(
            ...
            [
                'methods'             => 'GET',
                'callback'            => [$this, 'get_gateway_health_history'],
                'permission_callback' => [$this, 'check_permission'],
                'args'                => [
                    'gateway_id' => [
                        'type'        => 'string',
        ...
        register_rest_route(
            ...
            [
                'methods'             => 'POST',
                'callback'            => [$this, 'recalculate_all_health'],
                'permission_callback' => [$this, 'check_permission'],
            ]
        );
    }
    ...
    public function get_all_gateway_health($request)
    {
        ...
        // Validate period
        $valid_periods = ['1hour', '24hour', '7day'];
        ...
        try {
            ...
            if (empty($gateways)) {
                return $this->get_paginated_response([], 0, 1, 1);
            }
