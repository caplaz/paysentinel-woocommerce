...
class WC_Payment_Monitor_Health
{
    ...
    private function init_hooks()
    {
        ...
        add_action('init', [$this, 'schedule_health_calculation']);
        add_action('wc_payment_monitor_health_calculation', [$this, 'calculate_all_gateway_health']);

        // Hook into plugin activation to schedule cron
        add_action('wc_payment_monitor_activated', [$this, 'schedule_health_calculation']);
    }
    ...
    public function add_cron_interval($schedules)
    {
        ...
        $schedules['wc_payment_monitor_interval'] = [
            'interval' => $interval,
