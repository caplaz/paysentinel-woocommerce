...
/**
 * Class WC_Payment_Monitor_WC_Payments_Connector
 *
 * WooCommerce Payments-specific connectivity checker
 */
class WC_Payment_Monitor_WC_Payments_Connector extends WC_Payment_Monitor_Gateway_Connector {

	const WC_PAYMENTS_API = 'https://public-api.wordpress.com/wpcom/v2/sites';
