...
class WC_Payment_Monitor_Gateway_Manager {
	 ...
	 * Constructor
	 *
	 * @param WC_Payment_Monitor_License $license License instance (optional)
	 */
	public function __construct( $license = null ) {
		$this->license = $license ?? new WC_Payment_Monitor_License();
	}
