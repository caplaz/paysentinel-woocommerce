...
class WC_Payment_Monitor_Admin {
	...
	private function init_hooks() {
		...
		// AJAX handlers
		add_action( 'wp_ajax_wc_payment_monitor_slack_test', array( $this->ajax_handler, 'handle_slack_test' ) );
		add_action( 'wp_ajax_wc_payment_monitor_sync_integrations', array( $this->ajax_handler, 'handle_sync_integrations' ) );
		add_action( 'wp_ajax_wc_payment_monitor_validate_license', array( $this->ajax_handler, 'handle_validate_license_ajax' ) );
		...
		add_action( 'admin_post_wc_payment_monitor_deactivate_license', array( $this, 'handle_deactivate_license' ) );
		add_action( 'admin_post_wc_payment_monitor_save_license', array( $this->ajax_handler, 'handle_save_license' ) );
	}
