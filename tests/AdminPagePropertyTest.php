...
class AdminPagePropertyTest extends WC_Payment_Monitor_Test_Case
{
    ...
    protected function setUp(): void
    {
        ...
        if (!function_exists('add_submenu_page')) {
            function add_submenu_page($parent_slug, $page_title, $menu_title, $capability, $menu_slug, $function = '')
            {
                ...
                if (!isset($admin_submenu_pages[$parent_slug])) {
                    $admin_submenu_pages[$parent_slug] = [];
                }
                $admin_submenu_pages[$parent_slug][$menu_slug] = [
                    'page_title' => $page_title,
                    'menu_title' => $menu_title,
                    'capability' => $capability,
                    'menu_slug'  => $menu_slug,
        ...
        if (!function_exists('register_setting')) {
            function register_setting($option_group, $option_name, $args = [])
            {
                ...
                $registered_settings[$option_name] = [
    ...
    public function test_property_23_settings_form_fields_validation()
    {
        for ($i = 0; $i < 100; $i++) {
            ...
            $this->assertTrue(
                is_callable([$this->admin, 'render_settings_section']),
    ...
    public function test_property_24_admin_settings_retrieval_and_update()
    {
        for ($i = 0; $i < 100; $i++) {
            ...
            WC_Payment_Monitor_Admin::update_settings(['health_check_interval' => 20]);
    ...
    public function test_retry_configuration_validation()
    {
        ...
        $invalid_config = ['max_retry_attempts' => 15];
