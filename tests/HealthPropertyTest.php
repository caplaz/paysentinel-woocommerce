...
class HealthPropertyTest extends PHPUnit\Framework\TestCase {
    ...
    public function test_property_status_threshold_detection() {
        $test_cases = array(
            array('rate' => 100, 'expected' => 'healthy'),
            array('rate' => 95, 'expected' => 'healthy'),
            array('rate' => 94.9, 'expected' => 'degraded'),
            array('rate' => 50, 'expected' => 'degraded'),
            array('rate' => 49.9, 'expected' => 'down'),
            array('rate' => 0, 'expected' => 'down'),
        );
    ...
    public function test_property_period_calculations() {
        $periods = array(
            array('period' => '1hour', 'seconds' => 3600),
            array('period' => '24hour', 'seconds' => 86400),
            array('period' => '7day', 'seconds' => 604800),
        );
